...
//           <img src={heroBg} alt="" className="hero-banner-img" />
//         </div>
...
//           </p>
//           <Link to="/products" className="hero-banner-cta">
//             Browse All Products
...
//         <div className="container">
//           <div className="section-header">
//             <h2 className="section-title" data-animate="fade-up">Our Collection</h2>
