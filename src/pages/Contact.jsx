      ...
      <div className="container">
        <div style={{ padding: '3rem 0', textAlign: 'center' }}>
          ...
          <div className="contact-cards-row">
            ...
            {/* WhatsApp */}
            <a href={`https://wa.me/${contactWhatsApp}`} target="_blank" rel="noopener noreferrer" className="contact-card-block contact-card-link" onClick={() => trackEvent('ContactChannelClicked', { channel: 'whatsapp' })}>
              <div className="contact-card-icon-wrap">
