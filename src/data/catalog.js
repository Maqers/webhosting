...
export const productsByCategory = {
  ...
  "Handmade-Accessories": [
    ...
    },
    {
      ...
      featured: false,
      inStock: true,
      tags: ["oxidized earrings", "jhumka", "ghungroo", "statement earrings", "ethnic jewellery", "festive wear"],
      meta: {
        keywords: ["oxidized jhumka earrings",
    ...
    },
    {
      ...
      featured: false,
      inStock: true,
      tags: ["pastel earrings", "kundan earrings", "pearl fringe", "wedding jewellery", "festive wear", "ethnic earrings"],
      meta: {
        keywords: [ "pastel kundan earrings",
    ...
    "festive wear"],
      meta: {
        keywords: ["oxidized chandelier earrings",
    ...
    "festive wear"],
      meta: {
        keywords: ["black chandbali earrings",
    ...
    "festive jewellery"],
      meta: {
        keywords: ["layered jhumka earrings",
    ...
    "ghungroo earrings"],
      meta: {
        keywords: ["kundan jhumka earrings",
    ...
    "festive wear"],
      meta: {
        keywords: ["mini oxidized earrings",
    ...
    "statement set"],
      meta: {
        keywords: ["oxidized peacock necklace set",
    ...
    "ethnic jewellery"],
      meta: {
        keywords: ["antique gold jhumka earrings",
    ...
    "statement set"],
      meta: {
        keywords: [      "oxidized pendant necklace set",
      "tribal necklace set",
