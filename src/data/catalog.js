...
export const productsByCategory = {
  ...
  Candles: [
    ...
    },
    {
      id: 105,
      categoryId: "Candles",
      title: "Dark Roast Latte Soy Candle", //diyabati
      slug: "dark-roast-latte-soy-candle",
      description:
        "Rich, bold, and comforting, the Dark Roast Latte Candle is made for true coffee lovers. Hand-poured using natural soy wax, this candle captures the aroma of freshly brewed coffee—deep, roasted, and irresistibly familiar.",
      price: 699, //899
      images: ["/images/98.png","/images/98-1.png","/images/98-2.png"],
      popular: false,
      featured: false,
      inStock: true,
      tags: ["candle", "mini", "jar candle" , "aura", "scented"],
      meta: {
        keywords: ["candle", "bucket", "desk", "scented", "colorful"],
      },
    },
    {
      id: 106,
      categoryId: "Candles",
      title: "Vanilla Reed Diffuser", //diyabati
      slug: "vanilla-reed-diffuser",
      description:
        "Create a calm and inviting atmosphere with the Vanilla Reed Diffuser, designed to gently fill your space with a warm and comforting aroma. Infused with the rich scent of creamy vanilla, this diffuser releases a soft and continuous fragrance that transforms any room into a cozy retreat. The elegant glass bottle paired with a minimal gold accent adds a touch of sophistication, making it both a fragrance solution and a beautiful décor piece.",
      price: 350, //899
      images: ["/images/92.png","/images/92-1.png"],
      popular: false,
      featured: false,
      inStock: true,
      tags: ["candle", "mini", "vanilla", "scented"],
      meta: {
        keywords: ["candle", "bucket", "desk", "scented", "colorful"],
      },
    },
    ...
    },
    {
      id: 108,
      categoryId: "Candles",
      title: "Iced Caramel Vanilla Latte Soy Candle", //diyabati
      slug: "iced-caramel-vanilla-latte-soy-candle",
      description:
        "Indulge in the comforting aroma of your favorite café treat with the Iced Caramel Vanilla Latte Candle—crafted to bring warmth, sweetness, and a touch of everyday luxury into your space. Blending rich caramel with creamy vanilla and subtle coffee undertones, this candle recreates the essence of a perfectly made iced latte. The beautifully layered wax design, inspired by swirls of milk and caramel, paired with delicate “ice cube” detailing on top, makes it as visually irresistible as it is fragrant.",
      price: 549, 
      images: ["/images/94.png","/images/94-1.png","/images/94-2.png"],
      popular: false,
      featured: false,
      inStock: true,
      tags: ["candle", "mini", "bucket", "colorful", "scented"],
    ...
    },
    {
      id: 109,
      categoryId: "Candles",
      title: "Royal White Musk Soy Candle", //diyabati
      slug: "royal-white-musk-soy-candle",
      description:
        "Experience understated luxury with the Royal White Musk Candle, crafted to bring a sense of calm sophistication and quiet elegance to your space. Infused with the soft, sensual notes of white musk, this candle offers a clean and refined fragrance that lingers beautifully without overpowering. Its smooth, powdery aroma creates a serene ambience—perfect for unwinding after a long day or elevating your everyday surroundings. Housed in a sleek matte black jar with a wooden lid, this candle embodies modern minimalism with a royal touch—making it a statement piece for any décor style.",
      price: 599, 
      images: ["/images/95.png","/images/95-1.png","/images/95-2.png"],
      popular: false,
      featured: false,
      inStock: true,
      tags: ["candle", "jar", "white musk", "colorful", "scented"],
      meta: {
        keywords: ["candle", "desk", "scented", "colorful"],
      },
    },
    {
      id: 110,
      categoryId: "Candles",
      title: "Pink Champagne Celebration Soy Candle", //diyabati
      slug: "mini-bucket-candle",
      description:
        "Bright, joyful, and effortlessly elegant, Pink Champagne Celebration is crafted to capture the sparkling spirit of special moments. Hand-poured in small batches using 100% natural soy wax, this candle carries a lively fragrance inspired by sweet berries and bubbly champagne. Set in a refined minimal glass jar, it brings a luxurious yet playful touch to your space — perfect for celebrations, gatherings, or simply elevating everyday moments. The scent feels festive and uplifting, with a soft sweetness that lingers beautifully, creating a warm and cheerful ambience wherever it’s placed.",
      price: 499, 
      images: ["/images/96.png","/images/96-1.png"],
      popular: false,
      featured: false,
      inStock: true,
      tags: ["candle", "colorful", "scented"],
      meta: {
        keywords: ["candle", "desk", "scented", "colorful"],
      },
    },
